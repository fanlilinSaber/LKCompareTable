...
class Example04ViewController: UIViewController {
    ...
    lazy var compareTableView: ZJKCompareTableView = {
        let tableView = ZJKCompareTableView(frame: .zero, headerStyle: .follow)
        tableView.register(ZJKCompareTableItemTest01Cell.self, forCellReuseIdentifier: "ZJKCompareTableItemTest01Cell")
        tableView.dataSourcePlug = ZJKCompareTableMorePlug(delegate: self)
...
//                    item.text = "¥3400.00/吨"
    ...
    /// 测试数据
    let test2Data: [ZJKCompareTableMoreModel] = {
        var data = [ZJKCompareTableMoreModel]()
...
extension Example04ViewController: ZJKCompareTableViewHeaderDataSource {
...
extension Example04ViewController: ZJKCompareTableViewDelegate {
...
extension Example04ViewController: ZJKCompareTableMorePlugDelegate {
    
    func compareTableView(_ compareTableView: ZJKCompareTableView, didSelectRowAt indexPath: IndexPath, to index: Int, is truncated: Bool, deal result: Any?) {
