//
//  ZJKCompareTableTest01FieldView.swift
...
@objcMembers
class ZJKCompareTableTest01FieldView: ZJKCompareTableFieldView {
    ...
    required init(style: ZJKCompareTableFieldView.FieldStyle, reuseIdentifier: String?) {
