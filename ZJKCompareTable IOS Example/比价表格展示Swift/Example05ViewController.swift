...
class Example05ViewController: UIViewController {
    ...
    lazy var compareTableView: ZJKCompareTableView = {
        let tableView = ZJKCompareTableView(frame: .zero, headerStyle: .suspending)
...
extension Example05ViewController: ZJKCompareTableViewPinHeaderDataSource {
...
extension Example05ViewController: ZJKCompareTableViewDelegate {
...
extension Example05ViewController: ZJKCompareTableMorePlugDelegate {
