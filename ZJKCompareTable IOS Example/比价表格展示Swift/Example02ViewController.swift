...
open class Example02ViewController: UIViewController {
    ...
    /// 测试数据
    let testData: [[ZJKCompareTableTest01Model]] = {
        var data = [[ZJKCompareTableTest01Model]]()
        ...
        var array0 = [ZJKCompareTableTest01Model]()
        for name in attrNames0 {
            let model = ZJKCompareTableTest01Model()
            model.attrName = name;
        ...
        var array1 = [ZJKCompareTableTest01Model]()
        ...
        var array2 = [ZJKCompareTableTest01Model]()
...
extension Example02ViewController: ZJKCompareTableViewDataSource {
