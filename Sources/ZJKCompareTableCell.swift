...
class ZJKCompareTableCell: UITableViewCell {
    ...
    public func cellForItem(at index: Int) -> ZJKCompareTableItemCell? {
        guard contentStackView.arrangedSubviews.count > index else {
            return nil
        }
        return contentStackView.arrangedSubviews[index] as? ZJKCompareTableItemCell;
    }
    ...
    public func setItemCell(with number: Int, itemCellWidth width: CGFloat,_ closure: (_ index: Int) -> UIView?) {
        ...
        for index in 0..<number {
            ...
            if width != ZJKCompareTableView.automaticDimension {
            ...
            if (view == nil) {
                ...
                if cell.isKind(of: ZJKCompareTableItemCell.self) {
    ...
    ///   - width: 宽度
    ///   - view: FieldView
    public func setFieldView(with width: CGFloat, field view: ZJKCompareTableFieldView) {
    ...
    typealias indexBlock = (_ index: Int, _ itemCell: ZJKCompareTableItemCell) -> Void
    ...
    /// 左边的字段栏
    public private(set) var fieldView: ZJKCompareTableFieldView?
    ...
    /// 侧边自适应内容父视图
    public private(set) lazy var contentStackView: ZJKCompareTableStackView = {
        let stackView = ZJKCompareTableStackView()
    ...
    @objc private func handleTapGesture(_ sender: UITapGestureRecognizer) {
        ...
        didSelectIndexCall?(sender.view?.tag ?? 0, sender.view as! ZJKCompareTableItemCell)
    }
...
class ZJKCompareTableAttrNameView: UIView {
