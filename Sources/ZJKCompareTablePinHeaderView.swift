//
//  ZJKCompareTablePinHeaderView.swift
//  ZJKCompareTable
//
...
open class ZJKCompareTablePinHeaderView: UIView {
    ...
    public typealias indexBlock = (_ index: Int, _ itemCell: ZJKCompareTableItemCell) -> Void
