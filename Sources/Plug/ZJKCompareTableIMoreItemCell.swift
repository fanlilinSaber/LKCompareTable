//
//  ZJKCompareTableIMoreItemCell.swift
//  ZJKCompareTable
//
...
class ZJKCompareTableIMoreItemCell: ZJKCompareTableItemCell {
    
    // MARK: - ***** Public method *****
    
    public func setAlignment(_ alignment: ZJKCompareTableMoreFieldModel.ContentAlignment) {
    ...
    private var contentAlignment: ZJKCompareTableMoreFieldModel.ContentAlignment = .topLeft
    
    // MARK: - ***** Class method *****
    
    // MARK: - ***** Init method *****
    
    required public init(style: ZJKCompareTableItemCell.ItemStyle, reuseIdentifier: String?) {
