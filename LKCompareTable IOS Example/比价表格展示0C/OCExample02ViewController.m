...
#import "LKOCCompareTableTest01Model.h"

@interface OCExample02ViewController () <LKCompareTableViewDataSource>
/// compareTableView
...
- (NSArray<NSArray<LKOCCompareTableTest01Model *> *> *)testData
{
    if (_testData == nil) {
        ...
        for (NSString *name in attrNames1) {
            LKOCCompareTableTest01Model *model = LKOCCompareTableTest01Model.new;
            model.attrName = name;
